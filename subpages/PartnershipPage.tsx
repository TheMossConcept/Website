    ...
    <PageContainer>
      ...
      <TextSection
        textSections={[
          ...
          'We will challenge your perception whenever we deem it appropriate to help you achieve maximum business value. As we are experts in IT, we can help you realize potential you did not know about, and help you avoid pitfalls - particularly when we have a solid understanding of your business. We believe we can add valuable knowledge and experience to your software development journey.',
      ...
      <TextSection
        textSections={[
          ...
          'We will always provide our recommendations and challenge your perception when we deem it appropriate, however, in the end, you are the one making the decisions. That is why it is important to us to be transparent and clear and work to make IT understandable and accessible to you.'
        ]}
        mt={16}
      />
      <MediaSection
