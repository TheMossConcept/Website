  ...
  return (
    <PageContainer>
      <FirstSubpageSection
        ...
        text="Our purpose is to free up time and energy for what truly matters. In the context of your business, that means better support for your essential workflows and less time wasted on repetitive tasks that do not fully utilize the skills of your employees. In turn, this leads to employees who are more productive and fulfilled"
      />
      <MainPointSection
